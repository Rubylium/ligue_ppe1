...
?>
	...
	<div id="logreg-forms">
		<form action="?action=modifierSubValide" method="post" class="form-signin">
			<h1 class="h3 mb-3 font-weight-normal" style="text-align: center">Modification de poste</h1>

			<input type="hidden" name="inputNum" class="form-control" value="<?= $data->GetnPoste() ?>" placeholder="Numero de poste" required="" autofocus="">
			...
			<button class="btn btn-success btn-block" type="submit"><i class="fas fa-sign-in-alt"></i>Modifier</button>
			<hr>
		</form>
	</div>
<?php
